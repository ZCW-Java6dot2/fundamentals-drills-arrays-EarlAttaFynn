...
public class MathUtilities {
    ...
    public Short add(short baseValue, short difference) {
        ...
        int sum = (int)baseValue + (int)difference;
    ...
    public Short divide(short dividend, short divisor) {
        int result = (short)dividend / (short) divisor;
        Short division = (short)result;
        return division;
    }
    ...
    public Byte divide(byte dividend, byte divisor) {
        int result = (byte)dividend / (byte) divisor;
        Byte division = (byte)result;
        return division;
    }
    ...
    public Short multiply(short multiplicand, short multiplier) {
        int notShort = multiplicand * multiplier;
        Short product = (short)notShort;
        return product;
    }
    /**
     * @param multiplicand value to be multiplied
